...
struct Camera
{
    ...
    void processKeyboard(Camera_Movement direction, F deltaTime)
    {
        F velocity = movementSpeed * deltaTime;
    ...
    void processMouseMovement(F xoffset, F yoffset, GLboolean constrainPitch = true)
    {
    ...
    void processMouseScroll(F yoffset)
    {
